...
- **Удобство интерфейса:** заметный индикатор расхода виртуального бюджета, различие между районными и городскими мерами, сдержанная светлая тема, компактная сводка результата и шкалы баллов районов.
...
- **Отказ AI (проверка устойчивости):** включите «Показать работу без AI» и снова запросите объяснение. API не вызывается; Score и три таблицы остаются, текст подписан как резервный. После проверки снимите отметку.
