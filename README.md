...
- **Удобство интерфейса:** заметный индикатор расхода виртуального бюджета, различие между районными и городскими мерами, лёгкая анимация и поддержка системной настройки уменьшения движения.
...
frontend/
  ...
  theme.py                визуальная тема, адаптивные стили и анимации
