...
Для версии, на которой подготовлен этот README, результат — **110 пройденных тестов**. Проверяются контрольные числа, бюджет, несовместимости, лаги всех 14 мер, три синергии, городские эффекты, границы 0–100, неизменность исходных данных, все 120 перестановок контрольного набора, AI-ответы, проверка ответов модели и использование районного датасета в интерфейсе.
