...
def apply_theme() -> None:
    st.markdown(
        ...
        .app-brand { color:var(--ink); font-size:1rem; font-weight:600; letter-spacing:-.025em; }
        .city-hero { text-align:center; padding:3.6rem 0 3rem; margin-bottom:1rem; }
        ...
        .budget-status { color:var(--green); font-weight:500; font-size:.8rem; }
        ...
        .stButton button { min-height:2.8rem; border-radius:24px; font-weight:500; box-shadow:none; }
        ...
        <header class="app-masthead">
          <span class="app-brand">Аким на 5 часов</span>
